...
import { ZhilogChat } from "./ZhilogChat";
    ...
    deepSearch: (
      <div className={styles.message}>
        <div className={styles.avatar}>
          <div className={styles.avatarIcon}>ZL</div>
        </div>
  ...
  const handleSend = () => {
    ...
    const userMsg = (
      <div className={styles.message}>
        ...
        >
          <div className={styles.avatarIcon}>U</div>
        </div>
        <div className={styles.messageContent}>
          <div className={styles.messageHeader}>
