...
export default function ZhiLogLanding() {
        ...
        <div className="flex flex-col min-h-screen">
                        ...
                        <div className="grid gap-12 lg:gap-16">
                            ...
                            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                                ...
                                <div className="relative">
                                    ...
                                    <img
                                        src="https://assets.khoj.dev/zhilog/read_paper_deeply.png"
                            ...
                            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                                ...
                                <div className="relative">
                                    ...
                                    <img
                                        src="https://assets.khoj.dev/zhilog/grounded_citations.png"
                            ...
                            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                                ...
                                <div className="relative">
                                    ...
                                    <img
                                        src="https://assets.khoj.dev/zhilog/inline_annotations.png"
                            ...
                            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                                ...
                                <div className="relative">
                                    ...
                                    <img
                                        src="https://assets.khoj.dev/zhilog/paper_to_podcast.png"
                            ...
                            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                                ...
                                <div className="relative">
                                    ...
                                    <img
                                        src="https://assets.khoj.dev/zhilog/find_related_papers.png"
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <Button
                                        ...
                                        asChild
                                    >
                                        <a href="https://github.com/khoj-ai/zhilog" target="_blank" rel="noopener noreferrer">
            ...
            <footer className="flex flex-col gap-4 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-border/40 bg-muted/50">
                <p className="text-xs text-muted-foreground text-center sm:text-left">
                    Made with ❤️ in{" "}
                    <a
                        href="https://github.com/khoj-ai/zhilog"
                        target="_blank"
                ...
                <nav className="sm:ml-auto flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6">
                    ...
                    <Link href="https://github.com/khoj-ai/zhilog" className="text-xs hover:underline underline-offset-4 text-muted-foreground hover:text-primary">
                        GitHub
                    </Link>
